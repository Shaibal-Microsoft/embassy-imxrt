...
impl<M: Mode> ErrorType for FlexspiStorage<M> {
...
/// FlexSPI instance
pub struct FlexspiStorage<M: Mode> {
    /// FlexSPI HW Info Object
    info: Info,
...
impl BlockingReadNorFlash for FlexspiStorage<Blocking> {
...
impl BlockingNorFlash for FlexspiStorage<Blocking> {
...
impl crate::storage::BlockingNorStorageDriver for FlexspiStorage<Blocking> {
